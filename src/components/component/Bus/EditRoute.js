  ...
  return (
    <div className={classes.container}>
      <AppBar position="static" color="default">
        ...
        >
          <Tab label="Edit Source" {...a11yProps(0)} />
          <Tab label="Edit Destination" {...a11yProps(1)} />
        </Tabs>
      </AppBar>
      <SwipeableViews
        ...
        <TabPanel value={value} index={0} dir={theme.direction}>
          ...
          {successAlert ? (
            <Alert
              ...
              severity="success"
            >
              Source is successfully updated to the database!
            </Alert>
          ) : (
            ""
          )}
                ...
                ref.once("value", (snapshot) => {
                  snapshot.forEach((ds) => {
                    if (ds.child("start").val() === source) {
                      ref.child(ds.key).update({ start: start });
          ...
          >
            {!loading ? "Update Source" : <CircularProgress />}
          </Button>
        </TabPanel>
        <TabPanel value={value} index={1} dir={theme.direction}>
          ...
          {successAlert ? (
            <Alert
              ...
              severity="success"
            >
              Destination is successfully updated to the database!
            </Alert>
          ) : (
            ""
          )}
          ...
          >
            {!loading ? "Update Destination" : <CircularProgress />}
          </Button>
        </TabPanel>
      </SwipeableViews>
    </div>
